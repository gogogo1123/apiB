...
<div class="center_image">
    ...
    <img class="center_image_a" src="../image/연극1.jpg" alt="..."  width="600px" height="600px"/>
...
<table class="table" style="width: 700px;">
  ...
  <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="Name" aria-describedby="addon-wrapping" readonly="readonly" value="우리읍내">
</div>
