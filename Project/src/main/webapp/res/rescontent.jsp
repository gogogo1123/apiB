...
<script type="text/javascript">
	$(document).ready(function() {
		...
		bir = document.getElementById("today"); //아이디값을 반환 시켜줌...자바에서 리턴 값이나 다름없네..ㅎ.; id 요소에 접근할때 사용하는 객체..
		bir.value = today;
...
<div class="center_image">
    ...
    <img class="center_image_a" src="../image/연극.jpg" alt="..."  width="600px" height="600px"/>
...
<table class="table" style="width: 700px;">
  ...
  <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="Name" aria-describedby="addon-wrapping" readonly="readonly" value="별무리">
</div>
  ...
  <input type="text" class="form-control"  name="sell_price" aria-describedby="addon-wrapping" readonly="readonly" value="13000">
</div>
