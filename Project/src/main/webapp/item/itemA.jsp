...
<div class="center_image">
    ...
    <img class="center_image_a" src="../image/a.jpg" alt="..."  width="600px" height="600px"/>
...
<table class="table" style="width: 700px;">
  ...
  <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="itemName" aria-describedby="addon-wrapping" readonly="readonly" value="양자리 스티커">
</div>
