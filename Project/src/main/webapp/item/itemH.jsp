...
<div class="center_image">
    ...
    <img class="center_image_a" src="../image/h.jpg" alt="..."  width="600px" height="600px"/>
...
<table class="table" style="width: 700px;">
  ...
  <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="itemName" aria-describedby="addon-wrapping" readonly="readonly" value="암자리 스티커">
</div>
  ...
  <input type="text" class="form-control"  name="sell_price" aria-describedby="addon-wrapping" readonly="readonly" value="16500">
</div>
